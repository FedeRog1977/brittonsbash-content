...
\newpage
	...
	\begin{center}
		...
		\begin{center}
			\includegraphics[width=4cm,height=4cm]{tex_pics/steg.png}
		\end{center}
			\caption{Cover Object (Pre-Payload)}
		\end{subfigure}
		\begin{subfigure}[t]{6cm}
		\begin{center}
			\includegraphics[width=4cm,height=4cm]{tex_pics/neosteg.png}
		\end{center}
	...
	\begin{figure}[H]
        \begin{center}
                ...
                \begin{subfigure}[t]{6cm}
                \begin{center}
                        \includegraphics[width=4cm,height=4cm]{tex_pics/neosteg2.png}
                \end{center}
                        \caption{Stego-Object (Containing Payload)}
                \end{subfigure}
        \end{center}
