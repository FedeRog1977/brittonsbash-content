...
\hfill\vline\hfill
\begin{minipage}[t]{.80\linewidth}
	Manjaro, i3-Gaps, dwm, Polybar, Alacritty, st (Simple Terminal), Vim, neoVim, SC-IM, Ranger, Mutt, Calcurse, Newsboat, wget, cURL, cmus, mpv, Pandoc, pdflatex, XeLaTeX, LuaTeX, Beamer, M$\mu$PDF, Zathura, lynx, dxiv, GIMP, mop-tracker, tty-clock, FFmpeg, neofetch, cmatrix, asciiquarium, sl
\end{minipage}\\
