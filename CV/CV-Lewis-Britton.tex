...
\hfill\vline\hfill
\begin{minipage}[t]{.80\linewidth}
	Manjaro, i3-Gaps, dwm, Polybar, Alacritty, st (Simple Terminal), Vim, neoVim, SC-IM, Ranger, Thunderbird, Mutt, NeoMutt, Calcurse, Newsboat, wget, cURL, sxiv, cmus, mpd (ncmpcpp, mpc), mpv, Scrot, Pandoc, pdflatex, XeLaTeX, LuaTeX, Beamer, M$\mu$PDF, Zathura, lynx, GIMP, ticker, mop-tracker, tty-clock, FFmpeg, neofetch, cmatrix, asciiquarium, sl
\end{minipage}\\
