...
% Declaration
	...
	This document’s presentation reflects the use of {\LaTeX}\textcircled{\textsc{r}} typesetting (Figure B7), using Computer Modern Unicode (Figure B8). Tags are neglected to minimise bloat. References are presented using \textsc{Bib}{\TeX}, favouring \textsl{oblique} over \textit{italic}, in-line with Donald E. Knuth’s preference (Knuth, 2020). This escapes the inane formatting requirements of my institution. The process is executed in command line using Vim, which is a very powerful editor that has many commands, too many to explain in a tutor such as this. For the optimal viewing experience, the use of MuPDF is vigorously advised, with [-I]. Alias this operation ASAP. Navigate this document using $<$h, j, k, l$>$, ensuring that the Caps-Lock and/or your Super-Key is not depressed. Note that this study focuses on pragmatics and syntax, disregarding bloated filler content. Arguments are coherent, logical, definitive and straight-to-the-point. Nugatory theory is ignored.\\
 
	The word count reflects relevant content from paragraphs, titles, heading classes 1, 2 and 3, and footnotes in Chapters 1 to 6. Word count excludes tables, figures, table headings and figure headings and, any pre/succeeding content.\\
...
% Methodology
	...
	\subsection{Data Analysis}
		...
		For N observations; dependent variable Y; k explanatory\footnote{Semantic symmetry disregarded in favour of more-commonly used terms. See Figure B2 for correct terminology.} (X) variables; random error $\mathrm{\varepsilon_t}$ and; time t (Wooldridge, 2012).\\
...
% Appendices
	...
	\subsection*{Appendix 1: Existing Figures}
		...
		\subsubsection*{Figure A1: Average Daily Returns}
			...
			\begin{center}
				\includegraphics[width=7cm,height=3.5cm]{/Past-Lit-Pics/A1.png} 
			\end{center}
		...
		\subsubsection*{Figure A2: Trading \& Non-Trading Hour Daily Returns}
			...
			\begin{center}
                                \includegraphics[width=7cm,height=3.5cm]{/Past-Lit-Pics/A2.png}
                        \end{center}
		...
		\subsubsection*{Figure A3: Monday Returns Adjusted for Order Size}
                        ...
                        \begin{center}
                                \includegraphics[width=7cm,height=3.5cm]{/Past-Lit-Pics/A3.png}
                        \end{center}
		...
		\subsubsection*{Figure A4: Berkshire Hathaway’s Price Over Time}   
                        ...
                        \begin{center}
                                \includegraphics[width=6.5cm,height=3cm]{/Past-Lit-Pics/A4.png}
                        \end{center}
		...
		\subsubsection*{Figure A5: NYSE Total Value Over Time}  
                        ...
                        \begin{center}
                                \includegraphics[width=6.5cm,height=3cm]{/Past-Lit-Pics/A5.png}
                        \end{center}
		...
		\subsubsection*{Figure A6: NASDAQ Total Value Over Time}          
                        ...
                        \begin{center}
                                \includegraphics[width=6.5cm,height=3cm]{/Past-Lit-Pics/A6.png}
                        \end{center}
		...
		\subsubsection*{Figure A7: DJI Total Value Over Time} 
                        ...
                        \begin{center}
                                \includegraphics[width=6.5cm,height=3cm]{/Past-Lit-Pics/A7.png}
                        \end{center}
	...
	\newpage
		...
		\begin{longtable}{ p{14cm} }
			...
			\hline
			$$\mathrm{Y_t=\alpha+\beta_1X_1+\beta_2X_2+...+\beta_kX_k+\varepsilon_t}$$
			For N observations; dependent (response) variable Y; k independent (explanatory) (X) variables; random error $\mathrm{\varepsilon_t}$ and; time t (Wooldridge, 2012).\newline\newline 
			...
			All observations have constant errors, meaning that the variance of the residuals is constant. Therefore, they are homoscedastic; no need for a heteroscedasticity test (White, 1980) or the adjustment to a robust model.\newline\newline
			...
			$$\mathrm{Y_t=\alpha+\rho_1Y_{t-1}+...+\rho_pY_{t-p}+\varepsilon_t}$$\\
			Furthermore, for modelling financial time-series, the above is transformed into the Autoregressive Conditional Heteroscedasticity (ARCH) model (Bollerslev, 1986). This accounts for return volatility and an error function as follows:
			...
			\textbf{[7] Heteroskedasticity Test: }The `\underline{White Test}' is often used. Often referred to as `robustness test' finding need for robust standard errors. When there’re non-constant error terms (heteroscedasticity), OLS poorly fits a suitable line through the data.\newline\newline
			\textbf{Homoscedastic Errors: }constant error terms/error variance\newline
			\textbf{Heteroscedastic Errors: }non-constant error terms/error variance\newline\newline
			\textit{Aim to fail-to-reject:}\newline
			H$_0$: There is homoscedasticity present; there are constant error terms\newline\newline
			\textit{p-value desire flips with regards to hypothesis symmetry:}\newline
			p-value $>$ 0.05: fail-to-reject; there is no heteroscedasticity present; errors are constant\newline
			p-value $<$ 0.05: reject; there is heteroscedasticity present; errors are non-constant\newline\newline
			...
			H$_0$: $\phi=0\wedge\delta=0$; there is a uni-root present\newline\newline
		...
		\begin{tabular}{ p{3cm} p{5cm} p{5cm} }
			...
			Binary Explanatory & X Binary 1 results in a $<$\textit{coefficient}$>$ difference in Y over X Binary 0. & \textit{``A fund with a high-water mark has a $<$coefficient$>$ different value from a fund without one."}\\
			\hline
			...
			Binary Explanatory & X Binary 1 results in the odds of Y being Binary 1 by $<$\textit{coefficient}$>$ different units over X Binary 0. & \textit{``A fund with a high-water mark is $<$coefficient$>$ differently probable of being defunct than a fund without one."}\\
			\hline
		...
		\begin{tabular}{p{12cm}}
			...
			\hline
			\multicolumn{1}{c}{t-stat = $\mathit{\frac{\bar{x}-\bar{\mu}}{\left(\frac{\sigma^\mathrm{2}}{\sqrt{N}}\right)}}$}\\
	...
	\newpage
		...
		\subsubsection*{Figure B8: F\"{u}hrer Knuth's Computer Modern Unicode (CMU) Font Family}
