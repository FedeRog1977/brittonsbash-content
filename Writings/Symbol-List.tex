...
\section{Greek \& Hebrew Letters}
	...
	\begin{tabular}{ll|ll|ll|ll|ll|ll}
		...
		$\daleth$ & \verb|\daleth| & $\hbar$ & \verb|\hbar| & $\wp$ & \verb|\wp| & \texttrademark, \copyright & \verb|\trademark|, \verb|\copyright| & ! & \verb|!| & ``, '' & \verb|``|, \verb|''| or \verb|"| \\
		$\gimel$ & \verb|\gimel| & $\hslash$ & \verb|\hslash| & $\Bbbk$ & \verb|\Bbbk| & \textregistered, \circledR & \verb|\textregistered|, \verb|\circledR| & ? & \verb|?| & : & \verb|\colon| or \verb|:| \\
		$\imath$ & \verb|\imath| & $\top$ & \verb|\top| & $\emptyset$ & \verb|\emptyset| & $\diamondsuit$ & \verb|\diamondsuit| & $\natural$ &\verb|\natural| & ; & \verb|;| \\
		$\jmath$ & \verb|\jmath| & $\bot$ & \verb|bot| & $\infty$ & \verb|\infty| & $\heartsuit$ & \verb|\heartsuit| & $\sharp$ & \verb|\sharp| & & \\
		$\nabla$ & \verb|\nabla| & $\angle$ & \verb|\angle| & $\Box$ & \verb|\Box| & $\clubsuit$ & \verb|\clubsuit| & $\flat$ & \verb|\flat| & & \\
		$\triangle$ & \verb|\triangle| & $\surd$ & \verb|\surd| & $\Diamond$ & \verb|Diamond| & $\spadesuit$ & \verb|\spadesuit| & & & & \\
	\end{tabular}
	\end{center}
...
\section{Binary Operators}
	...
	\begin{center}
		\scriptsize
	\begin{tabular}{ll|ll|ll|ll}
		$\arccos$ & \verb|\arcoss| & $\csc$ & \verb|\csc| & $\injlim$ & \verb|\injlim| & $\max$ & \verb|\max| \\
		$\arcsin$ & \verb|\arcsin| & $\deg$ & \verb|\deg| & $\ker$ & \verb|\ker| & $\min$ & \verb|\min| \\
		$\arctan$ & \verb|\arctan| & $\det$ & \verb|\det| & $\lg$ & \verb|\lg| & $\Pr$ & \verb|\Pr| \\
		$\arg$ & \verb|\arg| & $\dim$ & \verb|\dim| & $\lim$ & \verb|\lim| & $\projlim$ & \verb|\projlim| \\
		$\cos$ & \verb|\cos| & $\exp$ & \verb|\exp| & $\liminf$ & \verb|\liminf| & $\sec$ & \verb|\sec| \\
		$\cosh$ & \verb|\cosh| & $\gcd$ & \verb|\gcd| & $\limsup$ & \verb|\limsup| & $\sin$ & \verb|\sin| \\
		$\cot$ & \verb|\cot| & $\hom$ & \verb|\hom| & $\ln$ & \verb|\ln| & $\sinh$ & \verb|\sinh| \\
