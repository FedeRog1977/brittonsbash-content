...
\section{Binary Relations}
	...
	\begin{center}
		\scriptsize
	\begin{tabular}{ll|ll|ll|ll|ll}
		$\lessdot$ & \verb|\lessdot| & $\gtrdot$ & \verb|\gtrdot| & $\subseteqq$ & \verb|\subseteqq| & $\supseteqq$ & \verb|\supseteqq| \\
		$\leqslant$ & \verb|\leqslant| & $\geqslant$ & \verb|\geqslant| & $\Subset$ & \verb|\Subset| & $\Supset$ & \verb|\Supset| \\
		$\eqslantless$ & \verb|\eqslantless| & $\eqslantgtr$ & \verb|\eqslantgtr| & $\sqsubset$ & \verb|\sqsubset| & $\sqsupset$ & \verb|\sqsupset| \\
		$\leqq$ & \verb|\leqq| & $\geqq$ & \verb|\geqq| & $\therefore$ & \verb|\therefore| & $\because$ & \verb|\because| \\
		$\lll$ & \verb|\lll| or \verb|\llless| & $\ggg$ & \verb|\gggtr| & $\shortmid$ & \verb|\shotmid| & $\shortparallel$ & \verb|\shortparallel| \\
		$\lessapprox$ & \verb|\lessapprox| & $\gtrapprox$ & \verb|\gtrapprox| & $\smallsmile$ & \verb|\smallsmile| & $\smallfrown$ & \verb|\smallfrown| \\
		$\lessgtr$ & \verb|\lessgtr| & $\gtrless$ & \verb|\gtrless| & $\vartriangleleft$ & \verb|\vartriangleleft| & $\vartriangleright$ & \verb|\vartriangleright| \\
		$\lesseqgtr$ & \verb|\lesseqgtr| & $\gtreqless$ & \verb|\gtreqless| & $\trianglelefteq$ & \verb|\trianglelefteq| & $\trianglerighteq$ & \verb|\trianglerighteq| \\
		$\lesseqqgtr$ & \verb|\lesseqqgtr| & $\gtreqqless$ & \verb|\gtreqqless| & $\blacktriangleleft$ & \verb|\blacktriangleleft| & $\blacktriangleright$ & \verb|\blacktriangleright| \\
		$\preccurlyeq$ & \verb|\precurlyeq| & $\succcurlyeq$ & \verb|\succcurlyeq| & $\doteqdot$ & \verb|\doteqdot| or \verb|\Doteq| & $\circeq$ & \verb|\circeq| & \\
		$\curlyeqprec$ & \verb|\curlyeqprec| & $\curlyeqsucc$ & \verb|\curlyeqsucc| & $\risingdotseq$ & \verb|\risingdotseq| & $\fallingdotseq$ & \verb|\fallingdotseq| \\
		$\precsim$ & \verb|\precsim| & $\succsim$ & \verb|\succsim| & $\eqcirc$ & \verb|\eqcirc| & $\triangleq$ & \verb|\tirangleeq| \\
