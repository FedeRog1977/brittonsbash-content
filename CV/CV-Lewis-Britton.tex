...
\pagenumbering{Roman}
	...
	\title{
		...
		%\Large\center{\textit{Bachelor of Arts }\textsc{Finance}}\\ \Large{\textit{Master of Science }\textsc{Software Development}}\\ \Large{\textit{Philosophiae Doctor} \textsc{Computer \& Information Sciences}}\\ [0.5cm]
		\HRule{0.5pt}
		\HRule{0.5pt}\\ [-0.45cm]
		}
	\date{}
...
\setlength\itemsep{0cm}
	\item Master of Science student of Software Development at the University of Strathclyde.
	\item Bachelor of Arts graduate of Finance at the University of Strathclyde. Focus on \textit{quantitative methods}, \textit{asset pricing}, \textit{corporate investment}, and \textit{corporate financing}. For more information on classes and projects visit my \href{http://lewisbritton.com/Academia.html}{academia} page.
	\item Through my interests, education and employment, I have constructed an ability to set and attain goals efficently, organise and plan in depth and maintain a strong work ethic, in balance. Visit my \href{http://lewisbritton.com/Employment.html}{employment} page for more.
...
\hfill\vline\hfill
\begin{minipage}[t]{.80\linewidth}
	Manjaro, i3-Gaps, dwm, Polybar, Alacritty, st (Simple Terminal), Vim, neoVim, SC-IM, Ranger, Thunderbird, Mutt, NeoMutt, Calcurse, Newsboat, wget, cURL, cmus, mpd (ncmpcpp, mpc), mpv, Pandoc, pdflatex, XeLaTeX, LuaTeX, Beamer, M$\mu$PDF, Zathura, lynx, dxiv, GIMP, mop-tracker, tty-clock, FFmpeg, neofetch, cmatrix, asciiquarium, sl
\end{minipage}\\
