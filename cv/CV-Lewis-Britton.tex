...
\hfill\vline\hfill
\begin{minipage}[t]{.80\linewidth}
	Manjaro, i3-Gaps, dwm, st (Simple Terminal), Vim, neoVim, SC-IM, ranger, mutt, calcurse, newsboat, cmus, mpv, pandoc, pdflatex, XeLaTeX, LuaTeX, Beamer, MuPDF, zathura, lynx, dxiv, GIMP, mop-tracker, tty-clock, neofetch, cmatrix, asciiquarium, sl
\end{minipage}\\
